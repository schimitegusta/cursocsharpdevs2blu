    ...
    public class SalvaContato
    {
        ...
        public MySqlDataReader GetContatos()
        {
            try
            {
                ...
                contatos.Nome = dataReader.GetString(1);
                contatos.Telefone = dataReader.GetString(2);
                contatos.Celular = dataReader.GetString(3);
                contatos.Email = dataReader.GetString(4);
                contatos.Rua = dataReader.GetString(5);
                contatos.Numero = dataReader.GetInt32(6);
                contatos.Bairro = dataReader.GetString(7);
                contatos.Cidade = dataReader.GetString(8);
                contatos.UF = dataReader.GetString(9);

                Compromissos compromissos = new Compromissos();
                compromissos.Titulo = dataReader.GetString(10);
                compromissos.Descricao = dataReader.GetString(11);
                compromissos.DataInicio = dataReader.GetDateTime(12);
                compromissos.DataFim = dataReader.GetDateTime(13);
